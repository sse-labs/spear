...
function compileFile() {
  ...
  /opt/homebrew/opt/llvm@17/bin/clang++ -g -O0 -fno-exceptions -fno-rtti -Xclang -disable-O0-optnone -fno-discard-value-names -S -emit-llvm -o "$path/compiled/$filename.ll" "$path/$filename.cpp"
  ...
  /opt/homebrew/opt/llvm@17/bin/clang++ -O0 -no-pie "$path/compiled/$filename.o" -o "$path/compiled/$filename"
