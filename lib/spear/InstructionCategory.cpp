...
bool InstructionCategory::isDivisionInstruction(llvm::Instruction &Instruction) {
    // check if the given instruction is a binaryinstruction and check for the opcode
    // of all division instructions in llvm ir
...
double InstructionCategory::getCalledFunctionEnergy(
    llvm::Instruction &Instruction,
    const std::vector<EnergyFunction*>& pool) {
