...
TestConfig loopBoundConfig = {.runFeasibilityAnalysis = false, .runLoopBoundAnalysis = true};
...
TEST_CASE("Arrayreducer_simple.ll") {
    ...
    INFO("Classifier increment " << "[" << firstClassifier.getLowerBound() << ", " << firstClassifier.getUpperBound()
                                 << "]");
    REQUIRE(firstClassifier ==
            LoopBound::DeltaInterval::interval(9000, 9000, LoopBound::DeltaInterval::ValueType::Additive));
}
...
TEST_CASE("Arrayreducer_complex.ll") {
    ...
    INFO("Classifier increment " << "[" << firstClassifier.getLowerBound() << ", " << firstClassifier.getUpperBound()
                                 << "]");
    REQUIRE(firstClassifier ==
            LoopBound::DeltaInterval::interval(2250, 2250, LoopBound::DeltaInterval::ValueType::Additive));
}
...
TEST_CASE("Arrayreducer_while.ll") {
    ...
    INFO("Classifier increment " << "[" << firstClassifier.getLowerBound() << ", " << firstClassifier.getUpperBound()
                                 << "]");
    REQUIRE(firstClassifier ==
            LoopBound::DeltaInterval::interval(3000, 3000, LoopBound::DeltaInterval::ValueType::Additive));
}
...
TEST_CASE("Arrayreducer_whileif.ll") {
    ...
    INFO("Classifier increment " << "[" << firstClassifier.getLowerBound() << ", " << firstClassifier.getUpperBound()
                                 << "]");
    REQUIRE(firstClassifier ==
            LoopBound::DeltaInterval::interval(2250, 3000, LoopBound::DeltaInterval::ValueType::Additive));
}
...
TEST_CASE("Arrayreducer_multiply.ll") {
    ...
    INFO("Classifier increment " << "[" << firstClassifier.getLowerBound() << ", " << firstClassifier.getUpperBound()
                                 << "]");
    REQUIRE(firstClassifier ==
            LoopBound::DeltaInterval::interval(9, 9, LoopBound::DeltaInterval::ValueType::Multiplicative));
}
...
TEST_CASE("Arrayreducer_negative.ll") {
    ...
    INFO("Classifier increment " << "[" << firstClassifier.getLowerBound() << ", " << firstClassifier.getUpperBound()
                                 << "]");
    REQUIRE(firstClassifier ==
            LoopBound::DeltaInterval::interval(392, 392, LoopBound::DeltaInterval::ValueType::Additive));
}
...
TEST_CASE("Arrayreducer_nonlinearincrementDIV.ll") {
    ...
    INFO("Classifier increment " << "[" << firstClassifier.getLowerBound() << ", " << firstClassifier.getUpperBound()
                                 << "]");
    REQUIRE(firstClassifier ==
        LoopBound::DeltaInterval::interval(5, 5, LoopBound::DeltaInterval::ValueType::Division));
}
...
TEST_CASE("Arrayreducer_whilenonlinearincrementWithIFMultipleFamily.ll") {
    ...
    INFO("Classifier increment " << "[" << firstClassifier.getLowerBound() << ", " << firstClassifier.getUpperBound()
                                 << "]");
    REQUIRE(firstClassifier ==
            LoopBound::DeltaInterval::interval(5000, 5000, LoopBound::DeltaInterval::ValueType::FALLBACK));
}
...
TEST_CASE("Arrayreducer_whilenonlinearincrementWithIFOneFamily.ll") {
    ...
    INFO("Classifier increment " << "[" << firstClassifier.getLowerBound() << ", " << firstClassifier.getUpperBound()
                                 << "]");
    REQUIRE(firstClassifier ==
            LoopBound::DeltaInterval::interval(4, 9, LoopBound::DeltaInterval::ValueType::Multiplicative));
}
