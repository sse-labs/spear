...
int benchmark_function(int input) {
    ...
    // Loop cluster 6
    // ---------------------------------------------------------------
    int l7 = opaque(input, 600);

    for (int p = 0; p < 52; ++p) {
        if ((opaque(l7 + p, 601) % 4) == 0) {
            l7 += 14;
        } else {
            l7 += 5;
        }

        if ((opaque(l7 + p, 602) & 2) != 0) {
            l7 += 21;
        } else {
            l7 += 7;
        }

        if ((opaque(l7 + p, 603) % 6) == 5) {
            l7 += 28;
        } else {
            l7 += 8;
        }

        if ((opaque(l7 + p, 604) & 16) != 0) {
            l7 += 13;
        } else {
            l7 += 4;
        }

        if ((opaque(l7 + p, 605) % 5) < 2) {
            l7 += 24;
        } else {
            l7 += 6;
        }

        if ((opaque(l7 + p, 606) & 8) != 0) {
            l7 += 31;
        } else {
            l7 += 9;
        }

        if ((opaque(l7 + p, 607) % 7) == 3) {
            l7 += 17;
        } else {
            l7 += 5;
        }

        if ((opaque(l7 + p, 608) % 9) < 4) {
            l7 += 22;
        } else {
            l7 += 7;
        }

        if ((opaque(l7 + p, 609) % 11) == 6) {
            l7 += 26;
        } else {
            l7 += 8;
        }
    ...
    // Loop cluster 8
    // ---------------------------------------------------------------
    int l8 = opaque(input, 600);

    for (int p = 0; p < 52; ++p) {
        if ((opaque(l8 + p, 601) % 4) == 0) {
            l8 += 14;
        } else {
            l8 += 5;
        }

        if ((opaque(l8 + p, 602) & 2) != 0) {
            l8 += 21;
        } else {
            l8 += 7;
        }

        if ((opaque(l8 + p, 603) % 6) == 5) {
            l8 += 28;
        } else {
            l8 += 8;
        }

        if ((opaque(l8 + p, 604) & 16) != 0) {
            l8 += 13;
        } else {
            l8 += 4;
        }

        if ((opaque(l8 + p, 605) % 5) < 2) {
            l8 += 24;
        } else {
            l8 += 6;
        }

        if ((opaque(l8 + p, 606) & 8) != 0) {
            l8 += 31;
        } else {
            l8 += 9;
        }

        if ((opaque(l8 + p, 607) % 7) == 3) {
            l8 += 17;
        } else {
            l8 += 5;
        }

        if ((opaque(l8 + p, 608) % 9) < 4) {
            l8 += 22;
        } else {
            l8 += 7;
        }

        if ((opaque(l8 + p, 609) % 11) == 6) {
            l8 += 26;
        } else {
            l8 += 8;
        }
    ...
    // Loop cluster 9
    // ---------------------------------------------------------------
    int l9 = opaque(input, 600);

    for (int p = 0; p < 52; ++p) {
        if ((opaque(l9 + p, 601) % 4) == 0) {
            l9 += 14;
        } else {
            l9 += 5;
        }

        if ((opaque(l9 + p, 602) & 2) != 0) {
            l9 += 21;
        } else {
            l9 += 7;
        }

        if ((opaque(l9 + p, 603) % 6) == 5) {
            l9 += 28;
        } else {
            l9 += 8;
        }

        if ((opaque(l9 + p, 604) & 16) != 0) {
            l9 += 13;
        } else {
            l9 += 4;
        }

        if ((opaque(l9 + p, 605) % 5) < 2) {
            l9 += 24;
        } else {
            l9 += 6;
        }

        if ((opaque(l9 + p, 606) & 8) != 0) {
            l9 += 31;
        } else {
            l9 += 9;
        }

        if ((opaque(l9 + p, 607) % 7) == 3) {
            l9 += 17;
        } else {
            l9 += 5;
        }

        if ((opaque(l9 + p, 608) % 9) < 4) {
            l9 += 22;
        } else {
            l9 += 7;
        }

        if ((opaque(l9 + p, 609) % 11) == 6) {
            l9 += 26;
        } else {
            l9 += 8;
        }
    ...
    // Loop cluster 10
    // ---------------------------------------------------------------
    int l10 = opaque(input, 600);

    for (int p = 0; p < 52; ++p) {
        if ((opaque(l10 + p, 601) % 4) == 0) {
            l10 += 14;
        } else {
            l10 += 5;
        }

        if ((opaque(l10 + p, 602) & 2) != 0) {
            l10 += 21;
        } else {
            l10 += 7;
        }

        if ((opaque(l10 + p, 603) % 6) == 5) {
            l10 += 28;
        } else {
            l10 += 8;
        }

        if ((opaque(l10 + p, 604) & 16) != 0) {
            l10 += 13;
        } else {
            l10 += 4;
        }

        if ((opaque(l10 + p, 605) % 5) < 2) {
            l10 += 24;
        } else {
            l10 += 6;
        }

        if ((opaque(l10 + p, 606) & 8) != 0) {
            l10 += 31;
        } else {
            l10 += 9;
        }

        if ((opaque(l10 + p, 607) % 7) == 3) {
            l10 += 17;
        } else {
            l10 += 5;
        }

        if ((opaque(l10 + p, 608) % 9) < 4) {
            l10 += 22;
        } else {
            l10 += 7;
        }

        if ((opaque(l10 + p, 609) % 11) == 6) {
            l10 += 26;
        } else {
            l10 += 8;
        }
